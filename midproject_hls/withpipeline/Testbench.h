...
public:
  ...
  cynw_p2p< sc_dt::sc_uint<8> >::base_out o_b;
	cynw_p2p< sc_dt::sc_uint<32> >::base_in i_greyr;
  cynw_p2p< sc_dt::sc_uint<32> >::base_in i_greyg;
  cynw_p2p< sc_dt::sc_uint<32> >::base_in i_greyb;
#else
	sc_fifo_out< sc_dt::sc_uint<8> > o_r;
  sc_fifo_out< sc_dt::sc_uint<8> > o_g;
  sc_fifo_out< sc_dt::sc_uint<8> > o_b;
	sc_fifo_in< sc_dt::sc_uint<32> > i_greyr;
  sc_fifo_in< sc_dt::sc_uint<32> > i_greyg;
  sc_fifo_in< sc_dt::sc_uint<32> > i_greyb;
#endif
