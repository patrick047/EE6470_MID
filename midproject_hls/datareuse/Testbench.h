...
public:
	...
	cynw_p2p< sc_dt::sc_uint<8> >::base_in i_resultr;
	cynw_p2p< sc_dt::sc_uint<8> >::base_in i_resultg;
	cynw_p2p< sc_dt::sc_uint<8> >::base_in i_resultb;
#else
	sc_fifo_out<sc_uint<8> > o_r;
  sc_fifo_out<sc_uint<8> > o_g;
  sc_fifo_out<sc_uint<8> > o_b;
  sc_fifo_in<sc_uint<8> > i_resultr;
  sc_fifo_in<sc_uint<8> > i_resultg;
  sc_fifo_in<sc_uint<8> > i_resultb;
#endif
