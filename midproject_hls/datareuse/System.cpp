	...
	tb("tb"), GaussianBlurFilter("GaussianBlurFilter"), clk("clk", CLOCK_PERIOD, SC_NS), rst("rst"), _output_bmp(output_bmp)
{
    ...
    tb.o_g(source_g);
    tb.o_b(source_b);
    tb.i_resultr(result_r);
    tb.i_resultg(result_g);
    tb.i_resultb(result_b);
	GaussianBlurFilter.i_r(source_r);
	GaussianBlurFilter.i_g(source_g);
	GaussianBlurFilter.i_b(source_b);
	GaussianBlurFilter.o_resultr(result_r);
	GaussianBlurFilter.o_resultg(result_g);
	GaussianBlurFilter.o_resultb(result_b);
